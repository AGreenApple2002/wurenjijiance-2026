...
DEFAULT_WEIGHTS = (
    ...
    "runs/detect/DroneVehicle/train7/weights/best.pt"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="DroneVehicle 视频检测并拼接原视频与预测视频。")
    parser.add_argument("input_video", help="输入视频路径，例如 input.mp4")
    parser.add_argument(
        "--output-video",
        default="outputs/dronevehicle_compare.mp4",
        help="输出视频路径，默认 outputs/dronevehicle_compare.mp4",
    )
    parser.add_argument(
        "--weights",
    ...
    parser.add_argument("--device", default="cpu", help='推理设备，CPU 用 "cpu"，GPU 用 "0"')
